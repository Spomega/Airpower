...
{
    public partial class AirtelMoneyPage : PhoneApplicationPage
    {
        public AirtelMoneyPage()
        {
            InitializeComponent();
        }
        ...
        private async void btnAirtelPayment_Click(object sender, RoutedEventArgs e)
        {
